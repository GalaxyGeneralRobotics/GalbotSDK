...
import numpy.typing
import typing
__all__: list[str] = ['ActuateType', 'AudioData', 'CLOSE_TO_OBSTACLE', 'COLLISION', 'COMM_DISCONNECTED', 'CYLINDER', 'CollisionCheckOption', 'CollisionInfo', 'ConfigItem', 'ConfigService', 'ControlStatus', 'DATA_FETCH_FAILED', 'DepthData', 'DetectionAndSegmentationResult', 'DetectionResult', 'DexHandType', 'DexhandState', 'EUCLIDEAN_DISTANCE', 'EffortInfo', 'EncodedVideoData', 'EndToolRawData', 'EndToolRxKind', 'EndToolSide', 'Error', 'ErrorInfo', 'FAILED', 'FAULT', 'FOUNDATION_STEREO', 'ForceData', 'FrameTriad', 'G1ControllerName', 'G1JointGroup', 'G3ControllerName', 'G3JointGroup', 'GalbotMotion', 'GalbotNavigation', 'GalbotOneFoxtrotSensor', 'GalbotPerception', 'GalbotRobot', 'GripperState', 'GroupCommand', 'Header', 'IKSolverConfig', 'INIT_FAILED', 'INTERRUPTED', 'INVALID_INPUT', 'IN_PROGRESS', 'ImuData', 'JOINT', 'JointCommand', 'JointState', 'JointStateMessage', 'JointStates', 'KinematicsBoundary', 'LIGHT_STEREO', 'LINE', 'LidarData', 'LineTrajCheckPrimitive', 'LogLevel', 'MachineType', 'MotionPlanChainTarget', 'MotionPlanConfig', 'MotionPlanTargetMode', 'MotionPlanType', 'MotionStatus', 'NavigationTaskSnapshot', 'NavigationTaskStatus', 'OCCUPIED', 'OdomData', 'POSE', 'PUBLISH_FAIL', 'Parameter', 'PerceptionModule', 'PlanRequest', 'PlannerConfig', 'Point', 'Point2d', 'PointField', 'PointFieldDataType', 'Pose', 'Pose2d', 'PoseState', 'PrimitiveType', 'Quaternion', 'RADIAN_DISTANCE', 'RANDOM_PROGRESSIVE_SEED', 'RANDOM_SEED', 'ROBOT_STATES', 'RUNNING', 'RgbData', 'RgbOutputFormat', 'RobotStates', 'RobotStatesType', 'S1ControllerName', 'S1JointGroup', 'STATUS_NUM', 'STOPPED_UNREACHED', 'SUCCESS', 'SUCTION_ACTION_STATE', 'SamplerConfig', 'SeedType', 'SensorStatus', 'SensorType', 'SingoriXTarget', 'StateCheckType', 'SuctionCupState', 'SyncedObservation', 'TARGET_DATA_DEFAULT', 'TARGET_DATA_FRAME_POSE', 'TARGET_DATA_FRAME_TWIST', 'TARGET_DATA_FRAME_WRENCH', 'TARGET_DATA_JOINT_ACCELERATION', 'TARGET_DATA_JOINT_EFFORT', 'TARGET_DATA_JOINT_POSITION', 'TARGET_DATA_JOINT_VELOCITY', 'TARGET_DATA_NONE', 'TARGET_TYPE_APPEND', 'TARGET_TYPE_CLEAR', 'TARGET_TYPE_DEFAULT', 'TARGET_TYPE_NONE', 'TARGET_TYPE_OVERRIDE', 'TARGET_TYPE_PREPENDNOW', 'TARGET_TYPE_PROVERRIDE', 'TARGET_TYPE_TOUCH', 'TIMEOUT', 'TIMEOUT_AND_EXACT_SOLUTION', 'TargetConfig', 'TargetGroupTrajectory', 'TargetSampling', 'TargetTaskTrajectory', 'TaskCommand', 'TaskHandle', 'TerminationConditionType', 'Timestamp', 'Trajectory', 'TrajectoryControlStatus', 'TrajectoryFeasibilityCheckOption', 'TrajectoryPlanConfig', 'TrajectoryPoint', 'Twist', 'UNKNOWN', 'UNSUPPORTED_FUNCRION', 'USER_DEFINED_SEED', 'UltrasonicData', 'UltrasonicType', 'Vector3', 'WBCException', 'Waypoint', 'WaypointParams', 'Wrench', 'check_motion_status', 'create_joint_state', 'create_parameter', 'create_pose_state']
class ActuateType:
    """
    Members:
      ...
      ACTUATE_TYPE_NUM
    """
    ACTUATE_TYPE_NUM: typing.ClassVar[ActuateType]  # value = <ActuateType.ACTUATE_TYPE_NUM: 3>
    ACTUATE_WITH_CHAIN_ONLY: typing.ClassVar[ActuateType]  # value = <ActuateType.ACTUATE_WITH_CHAIN_ONLY: 0>
    ACTUATE_WITH_LEG: typing.ClassVar[ActuateType]  # value = <ActuateType.ACTUATE_WITH_LEG: 2>
    ACTUATE_WITH_TORSO: typing.ClassVar[ActuateType]  # value = <ActuateType.ACTUATE_WITH_TORSO: 1>
    __members__: typing.ClassVar[dict[str, ActuateType]]  # value = {'ACTUATE_WITH_CHAIN_ONLY': <ActuateType.ACTUATE_WITH_CHAIN_ONLY: 0>, 'ACTUATE_WITH_TORSO': <ActuateType.ACTUATE_WITH_TORSO: 1>, 'ACTUATE_WITH_LEG': <ActuateType.ACTUATE_WITH_LEG: 2>, 'ACTUATE_TYPE_NUM': <ActuateType.ACTUATE_TYPE_NUM: 3>}
...
class ConfigItem:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def __init__(self, key: str, value: bool | typing.SupportsInt | typing.SupportsFloat | str | collections.abc.Sequence[typing.SupportsInt] | collections.abc.Sequence[typing.SupportsFloat] | collections.abc.Sequence[str] | collections.abc.Sequence[collections.abc.Sequence[typing.SupportsFloat]]) -> None:
        """
    ...
    def key(self, arg0: str) -> None:
        ...
    @property
    def value(self) -> bool | int | float | str | list[int] | list[float] | list[str] | list[list[float]]:
        """
        Value to assign with set_config(), or persisted value returned by get_config()
        """
    @value.setter
    def value(self, arg0: bool | typing.SupportsInt | typing.SupportsFloat | str | collections.abc.Sequence[typing.SupportsInt] | collections.abc.Sequence[typing.SupportsFloat] | collections.abc.Sequence[str] | collections.abc.Sequence[collections.abc.Sequence[typing.SupportsFloat]]) -> None:
        ...
class ConfigService:
    """
    ...
    FRONT_HEAD_CAMERA: typing.ClassVar[ConfigService]  # value = <ConfigService.FRONT_HEAD_CAMERA: 2>
    LEFT_ARM_CAMERA: typing.ClassVar[ConfigService]  # value = <ConfigService.LEFT_ARM_CAMERA: 0>
    MOTION_PLAN: typing.ClassVar[ConfigService]  # value = <ConfigService.MOTION_PLAN: 4>
    NAVIGATION: typing.ClassVar[ConfigService]  # value = <ConfigService.NAVIGATION: 5>
    RIGHT_ARM_CAMERA: typing.ClassVar[ConfigService]  # value = <ConfigService.RIGHT_ARM_CAMERA: 1>
    SURROUND_CAMERAS: typing.ClassVar[ConfigService]  # value = <ConfigService.SURROUND_CAMERAS: 3>
    __members__: typing.ClassVar[dict[str, ConfigService]]  # value = {'LEFT_ARM_CAMERA': <ConfigService.LEFT_ARM_CAMERA: 0>, 'RIGHT_ARM_CAMERA': <ConfigService.RIGHT_ARM_CAMERA: 1>, 'FRONT_HEAD_CAMERA': <ConfigService.FRONT_HEAD_CAMERA: 2>, 'SURROUND_CAMERAS': <ConfigService.SURROUND_CAMERAS: 3>, 'MOTION_PLAN': <ConfigService.MOTION_PLAN: 4>, 'NAVIGATION': <ConfigService.NAVIGATION: 5>, 'CONTROL': <ConfigService.CONTROL: 6>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class DexHandType:
    ...
    INSPIRE_RH56DFX: typing.ClassVar[DexHandType]  # value = <DexHandType.INSPIRE_RH56DFX: 1>
    INSPIRE_RH56F2: typing.ClassVar[DexHandType]  # value = <DexHandType.INSPIRE_RH56F2: 2>
    ...
    __members__: typing.ClassVar[dict[str, DexHandType]]  # value = {'INSPIRE': <DexHandType.INSPIRE: 0>, 'INSPIRE_RH56DFX': <DexHandType.INSPIRE_RH56DFX: 1>, 'INSPIRE_RH56F2': <DexHandType.INSPIRE_RH56F2: 2>, 'BRAINCO': <DexHandType.BRAINCO: 3>, 'SHARPA': <DexHandType.SHARPA: 4>, 'LINKER_L20': <DexHandType.LINKER_L20: 5>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class EndToolRxKind:
    ...
    """
    BUFFER_1KHZ: typing.ClassVar[EndToolRxKind]  # value = <EndToolRxKind.BUFFER_1KHZ: 0>
    BUFFER_250HZ: typing.ClassVar[EndToolRxKind]  # value = <EndToolRxKind.BUFFER_250HZ: 1>
    __members__: typing.ClassVar[dict[str, EndToolRxKind]]  # value = {'BUFFER_1KHZ': <EndToolRxKind.BUFFER_1KHZ: 0>, 'BUFFER_250HZ': <EndToolRxKind.BUFFER_250HZ: 1>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class EndToolSide:
    ...
    __members__: typing.ClassVar[dict[str, EndToolSide]]  # value = {'LEFT': <EndToolSide.LEFT: 0>, 'RIGHT': <EndToolSide.RIGHT: 1>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class G3ControllerName:
    """
    Controller-name constants for the G3 robot.
    
    Pass these names to controller-management APIs such as switch_controller() and
    acquire_controller(). The constants are client-side compatibility names, not a
    guarantee that every controller is registered by every G3 server configuration.
    The server may also expose additional controllers; check the switch result.
    """
    CHASSIS_POSE_CTRL: typing.ClassVar[str] = 'chassis_pose_ctrl'
    CHASSIS_TWIST_CTRL: typing.ClassVar[str] = 'chassis_twist_ctrl'
    CONTROLLER_NAME_NUM: typing.ClassVar[str] = 'CONTROLLER_NAME_NUM'
...
class GalbotMotion:
    ...
    def check_collision(self, start: collections.abc.Sequence[RobotStates], enable_collision_check: bool = True, params: Parameter = ...) -> tuple[MotionStatus, list[bool]]:
        ...
        """
    def check_collision_detail(self, robot_states: collections.abc.Sequence[RobotStates], is_check_once: bool = False, is_log: bool = False, params: Parameter = ...) -> tuple[MotionStatus, list[CollisionInfo]]:
        """
    ...
    def clear_obstacle(self) -> MotionStatus:
        ...
        """
    def combine_plan(self, plan_reqs: collections.abc.Sequence[PlanRequest], params: PlannerConfig = ..., start_state: RobotStates = None) -> tuple[MotionStatus, dict[str, list[list[float]]]]:
        """
    ...
    def get_chain_joint_state(self) -> dict[str, list[float]]:
        ...
        """
    def get_config_by_type(self, config_type: str) -> tuple[MotionStatus, MotionPlanConfig]:
        """
    ...
    def inverse_kinematics_by_state(self, target_pose: collections.abc.Sequence[typing.SupportsFloat], chain_names: collections.abc.Sequence[str], target_frame: str = 'EndEffector', reference_frame: str = 'base_link', reference_robot_states: RobotStates = None, enable_collision_check: bool = True, params: Parameter = ...) -> tuple[MotionStatus, dict[str, list[float]]]:
        """
                            ...
                            Returns:
                                dict: A dictionary mapping joint names to their computed positions.
        """
    def inverse_kinematics_general(self, target_waypoint: collections.abc.Sequence[MotionPlanChainTarget], reference_robot_states: RobotStates = None, params: Parameter = ...) -> tuple[MotionStatus, dict[str, JointStates]]:
        """
    ...
    def motion_plan(self, target: RobotStates, start: RobotStates = None, reference_robot_states: RobotStates = None, enable_collision_check: bool = True, params: Parameter = ...) -> tuple[MotionStatus, dict[str, list[list[float]]]]:
        ...
        """
    @typing.overload
    def motion_plan(self, waypoints: collections.abc.Sequence[collections.abc.Sequence[MotionPlanChainTarget]], params: PlannerConfig = ..., start_state: RobotStates = None) -> tuple[MotionStatus, dict[str, list[list[float]]]]:
        """
    ...
    def motion_plan_multi_waypoints(self, targets: collections.abc.Mapping[RobotStates, collections.abc.Sequence[collections.abc.Sequence[typing.SupportsFloat]]], start: collections.abc.Sequence[RobotStates] = [], reference_robot_states: RobotStates = None, enable_collision_check: bool = True, params: Parameter = ...) -> tuple[MotionStatus, dict[str, list[list[float]]]]:
        ...
        """
    def move_line(self, waypoints: collections.abc.Sequence[collections.abc.Sequence[MotionPlanChainTarget]], params: PlannerConfig = ..., start_state: RobotStates = None) -> tuple[MotionStatus, dict[str, list[list[float]]]]:
        """
    ...
    def set_end_effector_pose(self, target_pose: collections.abc.Sequence[typing.SupportsFloat], end_effector_frame: str, reference_frame: str = 'base_link', reference_robot_states: RobotStates = None, enable_collision_check: bool = True, is_blocking: bool = True, timeout: typing.SupportsFloat = -1.0, params: Parameter = ...) -> MotionStatus:
        ...
        """
    @typing.overload
    def set_end_effector_pose(self, target_pose: collections.abc.Sequence[typing.SupportsFloat], end_effector_frame: str, reference_frame: str, assist_chains: collections.abc.Set[str], reference_robot_states: RobotStates = None, enable_collision_check: bool = True, is_blocking: bool = True, timeout: typing.SupportsFloat = -1.0, params: Parameter = ...) -> MotionStatus:
        """
    ...
    def status_to_string(self, status: MotionStatus) -> str:
        ...
        """
    def traj_plan(self, waypoints: collections.abc.Sequence[collections.abc.Sequence[MotionPlanChainTarget]], params: PlannerConfig = ..., start_state: RobotStates = None) -> tuple[MotionStatus, dict[str, list[list[float]]]]:
        """
...
class GalbotNavigation:
    ...
    def get_instance(machine_type: MachineType) -> GalbotNavigation:
        """
                            ...
                            Parameters:
                                machine_type: MachineType enum (e.g. MachineType.G1 / MachineType.S1 / MachineType.G3)
                            Returns:
...
class GalbotPerception:
    ...
    def get_instance(machine_type: MachineType) -> GalbotPerception:
        """
                    ...
                    Args:
                        machine_type (MachineType): Platform selector, e.g. MachineType.G1, MachineType.S1, or MachineType.G3.
...
class GalbotRobot:
        ...
        """
                    ...
                    Returns:
                        dict: Dictionary containing camera intrinsic parameters.
                            ...
                            Returns empty dictionary on failure.
        """
    def get_config(self, service: ConfigService, keys: collections.abc.Sequence[str], use_default: bool = False) -> tuple:
        """
    ...
    def get_dexhand_state(self, end_effector: str, dexhand_type: DexHandType = ...) -> typing.Any:
        ...
        """
    def get_force_sensor_data(self, sensor_type: GalbotOneFoxtrotSensor, calibrated: bool = False, ref_frame: str = '') -> dict:
        """
    ...
    def get_odom(self) -> dict:
        """
                    ...
                    Returns:
                        ...
                        Returns empty dictionary on failure.
        """
    def get_rgb_data(self, camera_id: SensorType, format: RgbOutputFormat = ..., once: bool = True) -> dict:
        """
    ...
    def set_base_velocity(self, linear_velocity: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(3)"], angular_velocity: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(3)"], duration_s: typing.SupportsFloat = 0.0) -> ControlStatus:
        ...
        """
    def set_config(self, service: ConfigService, fields: collections.abc.Sequence[ConfigItem]) -> ControlStatus:
        """
    ...
    def set_joint_positions(self, joint_positions: collections.abc.Sequence[typing.SupportsFloat], joint_groups: collections.abc.Sequence[str] = [], joint_names: collections.abc.Sequence[str] = [], is_blocking: bool = True, speed_rad_s: typing.SupportsFloat = 0.2, timeout_s: typing.SupportsFloat = 15.0) -> ControlStatus:
        ...
        """
    def set_leg_height(self, link_height: typing.SupportsFloat, duration: typing.SupportsFloat = 4.0, is_blocking: bool = False, timeout_s: typing.SupportsFloat = -1.0) -> ControlStatus:
        """
    ...
    def stop_trajectory_execution(self) -> ControlStatus:
        """
                    ...
                    Returns:
                        ControlStatus: Command sending result.
        """
    def subscribe_video_data(self, camera_id: SensorType, callback: typing.Callable) -> SensorStatus:
        """
...
class MachineType:
    ...
    __members__: typing.ClassVar[dict[str, MachineType]]  # value = {'G1': <MachineType.G1: 0>, 'S1': <MachineType.S1: 1>, 'G3': <MachineType.G3: 2>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class MotionPlanTargetMode:
    ...
    """
    __members__: typing.ClassVar[dict[str, MotionPlanTargetMode]]  # value = {'kJoint': <MotionPlanTargetMode.kJoint: 0>, 'kCartesian': <MotionPlanTargetMode.kCartesian: 1>}
    kCartesian: typing.ClassVar[MotionPlanTargetMode]  # value = <MotionPlanTargetMode.kCartesian: 1>
    kJoint: typing.ClassVar[MotionPlanTargetMode]  # value = <MotionPlanTargetMode.kJoint: 0>
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class MotionPlanType:
    ...
    """
    MOTION_PLAN: typing.ClassVar[MotionPlanType]  # value = <MotionPlanType.MOTION_PLAN: 0>
    ...
    __members__: typing.ClassVar[dict[str, MotionPlanType]]  # value = {'MOTION_PLAN': <MotionPlanType.MOTION_PLAN: 0>, 'TRAJ_PLAN': <MotionPlanType.TRAJ_PLAN: 1>, 'MOVE_LINE': <MotionPlanType.MOVE_LINE: 2>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class Parameter(PlannerConfig):
    ...
    """
    def __init__(self, direct_execute: bool = False, blocking: bool = False, timeout: typing.SupportsFloat = 20.0, actuate: str = 'with_chain_only', tool_pose: bool = False, check_collision: bool = True, frame: str = 'base_link') -> None:
        ...
    def __repr__(self) -> str:
        ...
...
class PlanRequest:
    ...
    def target(self) -> list[list[MotionPlanChainTarget]]:
        ...
        """
    @target.setter
    def target(self, arg0: collections.abc.Sequence[collections.abc.Sequence[MotionPlanChainTarget]]) -> None:
        ...
class PlannerConfig:
    """
...
class RgbData:
    ...
    def plane_offset_bytes(self, arg0: typing.Annotated[collections.abc.Sequence[typing.SupportsInt], "FixedSize(2)"]) -> None:
        ...
    @property
    def stride_bytes(self) -> typing.Annotated[list[int], "FixedSize(2)"]:
        ...
        """
    @stride_bytes.setter
    def stride_bytes(self, arg0: typing.Annotated[collections.abc.Sequence[typing.SupportsInt], "FixedSize(2)"]) -> None:
        ...
    @property
    def width(self) -> int:
        """
...
class RgbOutputFormat:
    ...
    __members__: typing.ClassVar[dict[str, RgbOutputFormat]]  # value = {'JPEG': <RgbOutputFormat.JPEG: 0>, 'NV12': <RgbOutputFormat.NV12: 1>, 'BGR': <RgbOutputFormat.BGR: 2>, 'RGB': <RgbOutputFormat.RGB: 3>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class SensorStatus:
    ...
    """
    COMM_DISCONNECTED: typing.ClassVar[SensorStatus]  # value = <SensorStatus.COMM_DISCONNECTED: 9>
    DATA_FETCH_FAILED: typing.ClassVar[SensorStatus]  # value = <SensorStatus.DATA_FETCH_FAILED: 7>
    ...
    INVALID_INPUT: typing.ClassVar[SensorStatus]  # value = <SensorStatus.INVALID_INPUT: 3>
    IN_PROGRESS: typing.ClassVar[SensorStatus]  # value = <SensorStatus.IN_PROGRESS: 5>
    PUBLISH_FAIL: typing.ClassVar[SensorStatus]  # value = <SensorStatus.PUBLISH_FAIL: 8>
    STOPPED_UNREACHED: typing.ClassVar[SensorStatus]  # value = <SensorStatus.STOPPED_UNREACHED: 6>
...
class SensorType:
    ...
    Members:
      ...
      LEFT_ARM_DOWN_CAMERA : Left arm lower camera
    
      RIGHT_ARM_DOWN_CAMERA : Right arm lower camera
    ...
    BASE_ULTRASONIC: typing.ClassVar[SensorType]  # value = <SensorType.BASE_ULTRASONIC: 21>
    ...
    LEFT_ARM_DOWN_CAMERA: typing.ClassVar[SensorType]  # value = <SensorType.LEFT_ARM_DOWN_CAMERA: 4>
    LEFT_ARM_INFRA_CAMERA_1: typing.ClassVar[SensorType]  # value = <SensorType.LEFT_ARM_INFRA_CAMERA_1: 8>
    LEFT_ARM_INFRA_CAMERA_2: typing.ClassVar[SensorType]  # value = <SensorType.LEFT_ARM_INFRA_CAMERA_2: 9>
    LEFT_FRONT_SURROUND_CAMERA: typing.ClassVar[SensorType]  # value = <SensorType.LEFT_FRONT_SURROUND_CAMERA: 22>
    LEFT_REAR_SURROUND_CAMERA: typing.ClassVar[SensorType]  # value = <SensorType.LEFT_REAR_SURROUND_CAMERA: 24>
    ...
    RIGHT_ARM_DOWN_CAMERA: typing.ClassVar[SensorType]  # value = <SensorType.RIGHT_ARM_DOWN_CAMERA: 5>
    RIGHT_ARM_INFRA_CAMERA_1: typing.ClassVar[SensorType]  # value = <SensorType.RIGHT_ARM_INFRA_CAMERA_1: 10>
    RIGHT_ARM_INFRA_CAMERA_2: typing.ClassVar[SensorType]  # value = <SensorType.RIGHT_ARM_INFRA_CAMERA_2: 11>
    RIGHT_FRONT_SURROUND_CAMERA: typing.ClassVar[SensorType]  # value = <SensorType.RIGHT_FRONT_SURROUND_CAMERA: 23>
    RIGHT_REAR_SURROUND_CAMERA: typing.ClassVar[SensorType]  # value = <SensorType.RIGHT_REAR_SURROUND_CAMERA: 25>
...
def create_joint_state() -> JointStates:
    ...
    """
def create_parameter(direct_execute: bool = False, blocking: bool = False, timeout: typing.SupportsFloat = 20.0, actuate: str = 'with_chain_only', tool_pose: bool = False, check_collision: bool = True, frame: str = 'base_link') -> Parameter:
    """
