"""G3 motion_plan example aligned with motion_plan_example.cpp."""
...
def make_example_inputs(current):
    ...
    waypoints = [
        ...
        [
            cart("left_arm", spread("left_arm", 0.05)),
            cart("right_arm", spread("right_arm", -0.05)),
        ],
        [
            cart("left_arm", spread("left_arm", 0.10)),
            cart("right_arm", spread("right_arm", -0.10)),
        ],
        [
            make_joint_target(
                "left_arm",
...
def run_example():
    ...
    try:
        ...
        print(
            "Immediate execution is enabled; waypoints use the G3 reference "
